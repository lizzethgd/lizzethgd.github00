...
function createClient(params, opts = {}) {
  ...
  `${sdkMain}/${"7.20.0"}`, params.application, params.integration, params.feature);
...
function createEnvironmentApi(makeRequest) {
  ...
  return {
    ...
    createTag(id, name, visibility) {
      ...
      }).then(data => Object(_entities_tag__WEBPACK_IMPORTED_MODULE_3__["wrapTag"])(makeRequest, data));
    },
    ...
    getTags(query = {}) {
      ...
      }).then(data => Object(_entities_tag__WEBPACK_IMPORTED_MODULE_3__["wrapTagCollection"])(makeRequest, data));
    },
    ...
    getRelease(releaseId) {
      ...
      }).then(data => Object(_entities_release__WEBPACK_IMPORTED_MODULE_2__["wrapRelease"])(makeRequest, data));
    },
    ...
    getReleases(query) {
      ...
      }).then(data => Object(_entities_release__WEBPACK_IMPORTED_MODULE_2__["wrapReleaseCollection"])(makeRequest, data));
    },
